...
grab_ints([], _) ->
    no_sum;
grab_ints([Int|T], Type) ->
    case check_sum_2({Int, []}, T, Type) of 
        no_match ->
            grab_ints(T, Type);
        Match ->
            Match
...
check_sum_2({Num1, _}, [Num2|_], two) when Num1 + Num2 =:= 2020 ->
    Num1 * Num2;
check_sum_2(_Nums, [], two) ->
    no_match;
...
check_sum_2({Num1, [_, Num2|T]}, [], three) ->
    check_sum_2({Num1, [Num2|T]}, T, three);
